...
void testInputOutputCorrelation() {
    ...
    while (i <= 30) {
        ...
        if (isSquare(a)) {
            ...
            if      (i ==  1) { assert(afx ==   2); }
            else if (i ==  2) { assert(afx ==   5); }
            else if (i ==  3) { assert(afx ==  21); }
            else if (i ==  4) { assert(afx ==  42); }
            else if (i ==  5) { assert(afx == 152); }
            else if (i == 20) { assert(afx == 211345365); }
...
//  4               9409        43        90  AF(x) =         42, sqrt(a) 97        | diff:               6909        21        42        21
//  5             117649       153       310  AF(x) =        152, sqrt(a) 343       | diff:             108240       110       220       110
//  6             442225       297       598  AF(x) =        296, sqrt(a) 665       | diff:             324576       144       288       144
//  7            5527201      1051      2106  AF(x) =       1050, sqrt(a) 2351      | diff:            5084976       754      1508       754
//  8           20775364      2038      4080  AF(x) =       2037, sqrt(a) 4558      | diff:           15248163       987      1974       987
//  9          259660996      7206     14416  AF(x) =       7205, sqrt(a) 16114     | diff:          238885632      5168     10336      5168
// 10          976000081     13971     27946  AF(x) =      13970, sqrt(a) 31241     | diff:          716339085      6765     13530      6765
// 11        12198539809     49393     98790  AF(x) =      49392, sqrt(a) 110447    | diff:        11222539728     35422     70844     35422
// 12        45851228641     95761    191526  AF(x) =      95760, sqrt(a) 214129    | diff:        33652688832     46368     92736     46368
// 13       573071710225    338547    677098  AF(x) =     338546, sqrt(a) 757015    | diff:       527220481584    242786    485572    242786
// 14      2154031746244    656358   1312720  AF(x) =     656357, sqrt(a) 1467662   | diff:      1580960036019    317811    635622    317811
// 15     26922171840964   2320438   4640880  AF(x) =    2320437, sqrt(a) 5188658   | diff:     24768140094720   1664080   3328160   1664080
// 16    101193640845025   4498747   8997498  AF(x) =    4498746, sqrt(a) 10059505  | diff:     74271469004061   2178309   4356618   2178309
// 17   1264769004815281  15904521  31809046  AF(x) =   15904520, sqrt(a) 35563591  | diff:   1163575363970256  11405774  22811548  11405774
...
//  3  AF(x) =         21, sqrt(a) 50
//  4  AF(x) =         42, sqrt(a) 97         = SORR( 9)
//  5  AF(x) =        152, sqrt(a) 343
//  6  AF(x) =        296, sqrt(a) 665        = SORR(13)
//  7  AF(x) =       1050, sqrt(a) 2351
//  8  AF(x) =       2037, sqrt(a) 4558       = SORR(17)
//  9  AF(x) =       7205, sqrt(a) 16114
// 10  AF(x) =      13970, sqrt(a) 31241      = SORR(21)
// 11  AF(x) =      49392, sqrt(a) 110447
// 12  AF(x) =      95760, sqrt(a) 214129     = SORR(25)
